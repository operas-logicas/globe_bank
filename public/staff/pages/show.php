...
<div id="content">
    ...
    <div class="page show">
        ...
        <div class="actions">
            ...
            <!-- <a class="action" href="<?php echo url_for('/staff/pages/edit.php?id=' . $page['id']); ?>">Edit</a>&nbsp;&nbsp;
            <a class="action" href="<?php echo url_for('/staff/pages/delete.php?id=' . $page['id']); ?>">Delete</a>&nbsp;&nbsp; -->
        </div>
